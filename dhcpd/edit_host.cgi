...
# --- CUSTOM ADDED: Tempo (Mbps) Input Field ---
print "<tr><td><b>Internet Speed (Mbps)</b></td><td>\n";
print &ui_textbox("tempo", $host->{'tempo'}, 10);
print "</td></tr>\n";
# ---------------------------------------------
...
if (!$in{'new'}) {
    ...
    # --- CUSTOM ADDED: Disconnect and Activate Buttons ---
    print "<td>".&ui_submit("tempo_disconnect", "Tempo Disconnect")."</td>";
    print "<td>".&ui_submit("activate_host", "Activate")."</td>";
    # -----------------------------------------------------
